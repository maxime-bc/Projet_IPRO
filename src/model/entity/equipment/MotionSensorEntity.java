...
public class MotionSensorEntity extends EquipmentEntity {
    public MotionSensorEntity(int currentId, Owner owner, String brand, Date purchaseDate, double purchasePrice, State state, boolean isBorrowed, int storageID, int quantity) {
